...
export const LEVELS: LevelConfig[] = [
  {
    ...
    spawnRate: 46,
    obstacleTypes: [
      { type: 'asteroid', weight: 0.30 },
      { type: 'bomb', weight: 0.25 },
      { type: 'bird', weight: 0.30 },
      { type: 'crate', weight: 0.15 },
    ],
    powerUpFrequency: 310,
    targetDistance: 500,
    hasBoss: false,
  ...
  },
  {
    ...
    spawnRate: 35,
    obstacleTypes: [
      { type: 'asteroid', weight: 0.22 },
      { type: 'debris', weight: 0.15 },
      { type: 'drone', weight: 0.33 },
      { type: 'anomaly', weight: 0.1 },
      { type: 'mine', weight: 0.1 },
      { type: 'crate', weight: 0.1 },
    ],
  ...
  },
  {
    ...
    obstacleTypes: [
      ...
      { type: 'debris', weight: 0.20 },
      { type: 'drone', weight: 0.15 },
      { type: 'mine', weight: 0.1 },
      { type: 'anomaly', weight: 0.05 },
      { type: 'crate', weight: 0.12 },
    ],
    powerUpFrequency: 260,
    targetDistance: 1000,
    hasBoss: false,
